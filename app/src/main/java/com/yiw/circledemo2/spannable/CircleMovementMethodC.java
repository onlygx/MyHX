package com.yiw.circledemo2.spannable;
 ...
 * @date 16/1/2 16:54
 */
public class CircleMovementMethodC extends BaseMovementMethod {
    public final String TAG = CircleMovementMethodC.class.getSimpleName();
    ...
    public CircleMovementMethodC(){
        mTextViewBgColorId = DEFAULT_COLOR;
        mClickableSpanBgClorId = DEFAULT_COLOR;
    }

    public CircleMovementMethodC(int clickableSpanBgClorId){
        mClickableSpanBgClorId = clickableSpanBgClorId;
        mTextViewBgColorId = DEFAULT_COLOR;
    }

    public CircleMovementMethodC(int clickableSpanBgClorId, int textViewBgColorId){
        mClickableSpanBgClorId = clickableSpanBgClorId;
