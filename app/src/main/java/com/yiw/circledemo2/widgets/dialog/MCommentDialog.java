...
*
 */
public class MCommentDialog extends Dialog implements
		View.OnClickListener {

	private Context mContext;
	private MCirclePresenter mPresenter;
	private RecordListBean mCommentItem;
	private int mCirclePosition;

	public MCommentDialog(Context context, MCirclePresenter presenter,
						  RecordListBean commentItem, int circlePosition) {
