...
public class SelectPicPopupWindow2 extends PopupWindow {
    ...
    String tag;
    public SelectPicPopupWindow2(Activity context, View.OnClickListener itemsOnClick, String tag) {
        super(context);
        this.tag=tag;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.pop_update_picture, null);
        btn_take_photo = (TextView) mMenuView.findViewById(R.id.btn_take_photo);//从相册中选择
        btn_pick_photo = (TextView) mMenuView.findViewById(R.id.btn_pick_photo);//使用相机拍摄
