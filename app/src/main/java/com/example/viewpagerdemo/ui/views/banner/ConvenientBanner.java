...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public enum PageIndicatorAlign{
        ALIGN_PARENT_LEFT,ALIGN_PARENT_RIGHT,CENTER_HORIZONTAL,CENTER_BELOW
    }
    ...
    public ConvenientBanner(Context context, AttributeSet attrs) {
        ...
        showStyle= a.getInteger(R.styleable.ConvenientBanner_showStyle,0);
        a.recycle();
        init(context);
    }
    ...
    private void init(Context context) {
        View hView;
             hView = LayoutInflater.from(context).inflate(
                    R.layout.include_banner_rel, this, true);
            viewPager = (CBLoopViewPager) hView.findViewById(R.id.banner_view);
            loPageTurningPoint = (ViewGroup) hView
                    .findViewById(R.id.banner_point);
        initViewPagerScroll();
  ...
  /*  @Override
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
          ...
          //  ImageView pointView = new ImageView(getContext());
            ...
            pointView.setPadding(5, 0, 5, 20);
          //  pointView.setLayoutParams(new LayoutParams(10,10));
    ...
    /**
     */
    public ConvenientBanner setPagePadding(int left ,int top,int right ,int bottom) {
