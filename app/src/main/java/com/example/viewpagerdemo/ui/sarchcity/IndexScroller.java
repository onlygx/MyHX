...
public class IndexScroller
{
	...
	private boolean showIndexContainer = false; // whether to show the outer
												// index container
	private int indexbarContainerBgColor = android.R.color.transparent;// 右侧快捷字母背景
	private int indexPaintColor = Color.parseColor("#5093E1"); // 右侧字体颜色
	...
	public void drawSections(Canvas canvas)
	{
		...
		indexPaint.setAlpha((int) (255 * 0.8));
	...
	public void setAdapter(Adapter adapter)
	{
		...
		{
			ContactListAdapter cd = (ContactListAdapter) adapter;
			mIndexer = cd.getIndexer();
			mSections = (String[]) mIndexer.getSections();
		}
	}
