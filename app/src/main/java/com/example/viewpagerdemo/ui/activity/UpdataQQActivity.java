...
public class UpdataQQActivity extends JLBaseActivity {
    @Bind(R.id.iv_back)
    ImageView iv_back;
    @Bind(R.id.tv_title)
    TextView tv_title;
    ...
    public int setViewLayout() {
        return R.layout.activity_updata_qq;
    }
    ...
    public void onClick() {
        ...
        params.put("wechat",MyApplication.getInstan().getUser().getData().getWechat());
        ...
        fh.get(Contantor.FindInfo, params, new AjaxCallBack<String>() {
            ...
            public void onSuccess(String s) {
                ...
                if(js.isSuccess()){
                    MyApplication.getInstan().getUser().getData().setQq(name);
                    Intent it = new Intent(UpdataQQActivity.this, FindActivity.class);
                    it.putExtra("qq", name);
                    setResult(106, it);
                    finish();
                }
